...
@app.route('/prueba_test', methods=['POST'])
def prueba_test():
    data = request.json
    ...
    print(admin_id)
    print(admin_name)
    q2.enqueue("update_test", {
            'id': admin_id,
            'quantity': admin_name
        })
    return "¡Retorno de la ruta prueba_test del contenedor test con mensaje de cola: "
